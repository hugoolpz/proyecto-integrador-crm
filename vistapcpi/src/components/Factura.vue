              ...
              <q-card bordered class="tarjeta-factura">
                <q-card-section class="bg-azul-menta">
                  ...
                  <q-checkbox
                    ...
                    v-model="completada"
                    :label="
                      filtroMultiple.label == 'Solo emitidas'
                        ? '¿Está cobrada?'
                        : '¿Está pagada?'
                    "
                  />
                ...
                <ItemListaFactura
                  v-model="datosEmisor"
                  titulo-item="Datos del emisor de la factura"
                ...
                <ItemListaFactura
                  v-model="nFactura"
                  titulo-item="Número de la factura"
                ...
                <ItemListaFactura
                  ...
                  titulo-item="Fecha de la factura"
                ...
                <ItemListaFactura
                  v-model="baseImp"
                  titulo-item="Base imponible de la factura"
                  contenido-item="Base imponible (€)"
                >
                </ItemListaFactura>

                <ItemListaFactura
                  v-model="retencionIRPF"
                  titulo-item="Retención de IRPF de la factura"
                ...
                <ItemListaFactura
                  ...
                  titulo-item="Datos del remitente de la factura"
                  contenido-item="Nombre, apellidos, NIF, domicilio..."
                >
                </ItemListaFactura>
                ...
                <ItemListaFactura
                  v-model="metodo"
                  titulo-item="Método de pago de la factura"
