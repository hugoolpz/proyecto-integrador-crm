  ...
  <q-layout view="hHh lpR fFf">
    <q-header elevated class="bg-azul-oscuro text-white">
      <q-toolbar class="text-white shadow-2">
        ...
        <q-btn v-if="tab === 'facturas'" flat icon="fas fa-plus" @click="emitirFact = true" label="Emitir factura"
          class="bg-azul-menta" />
        <q-btn v-else-if="tab === 'proyectos'" flat icon="fas fa-plus" @click="emitirFact = true" label="Crear proyecto"
          class="bg-azul-menta" />
        <q-btn v-else flat icon="fas fa-plus" @click="emitirFact = true" label="Registrar cliente"
          class="bg-azul-menta" />
